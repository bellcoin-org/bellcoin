...
const char * const BITCOIN_CONF_FILENAME = "bellcoin.conf";
const char * const BITCOIN_PID_FILENAME = "bellcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bellcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bellcoin";
#else
    // Unix
    return pathRet / ".bellcoin";
#endif
#endif
}
